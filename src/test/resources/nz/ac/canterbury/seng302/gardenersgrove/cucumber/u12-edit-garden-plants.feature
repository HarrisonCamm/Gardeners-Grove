...
#        Then Then there is a scrollable list of plants
  ...
  Scenario Outline: AC8 - Updating a plant with a date that is not in the format DD/MM/YYYY
    ...
    Examples:
      ...
      | "plant10"| "10"  | "Tulip"        | "01/02/2030" | "Tulip G"   | "5"       | "Spring bloom"               | "25-Apr-2030"    |
      | "plant11"| "11"  | "Peony"        | "01/02/2031" | "Peony H"   | "3"       | "Perennial"                  | "April-25-2031"  |
      | "plant12"| "12"  | "Daisy"        | "01/02/2032" | "Daisy I"   | "2"       | "Bright and cheerful"        | "25-04-2032"     |
      | "plant13"| "13"  | "Lily"         | "01/02/2033" | "Lily J"    | "4"       | "Elegant flowers"            | "2033/25/04"     |
      | "plant14"| "14"  | "Chrysanthemum"| "01/02/2034" | "Chrysan K" | "1"       | "Autumn bloom"               | "April 25 2034"  |
