...
public class InventoryController {
    ...
    public String getTemplate(Model model) {
        ...
        // DUMMY DATA UNCOMMENT WHEN RUNNING TESTS
        if (badgeItems.isEmpty()) {
            badgeItems.add(itemService.getItemByName("Tim Tam"));
            badgeItems.add(itemService.getItemByName("Vegemite"));
            badgeItems.add(itemService.getItemByName("Neo Fabian"));
