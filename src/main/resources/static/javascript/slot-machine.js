    // const slots = [
    // [0, 1, 2, 3, 4], // Reel 1: Each number corresponds to an index in reelContents
    // [4, 3, 2, 1, 0], // Reel 2: Reversed order for variety
    // [2, 3, 4, 0, 1] // Reel 3: Random order
    // ];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelector('.container').addEventListener('click', startSpin);
